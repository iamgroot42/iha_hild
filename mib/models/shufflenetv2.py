"""
    Largely borrowed from https://raw.githubusercontent.com/weiaicunzai/pytorch-cifar100/master/models/shufflenetv2.py
"""
...
class ShuffleUnit(nn.Module):
    ...
    def forward(self, x):
        ...
        x = ch.cat([shortcut, residual], dim=1)
...
if __name__ == "__main__":
    ...
    net = ShuffleNetV2(100)
    y = net(Variable(ch.randn(1, 3, 32, 32)))
